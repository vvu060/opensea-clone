...
const style = {
  ...
  profileImage: `w-40 h-40 object-cover rounded-full border-2 border-[#202225] mt-[4rem]`,
  ...
  statusContainer: `w-[44vw] flex justify-between py-4 border border-[#151b22] rounded-xl mb-4`,
